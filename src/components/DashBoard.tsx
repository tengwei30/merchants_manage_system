        ...
        <Sider width={200} trigger={null} className="site-layout-background">
          ...
          >
            <SubMenu key="sub1" icon={<UserOutlined />} title="商品管理">
              ...
              <Menu.Item key="/good/sale">
                <Link to="/good/sale">出售中的商品</Link>
              </Menu.Item>
              <Menu.Item key="/good/illegal">
                <Link to="/good/illegal">仓库中的商品</Link>
              </Menu.Item>
              <Menu.Item key="/good/warehouse">
                <Link to="/good/warehouse">违规商品列表</Link>
              </Menu.Item>
            </SubMenu>
            <SubMenu key="sub2" icon={<LaptopOutlined />} title="店铺管理">
              <Menu.Item key="/shops/brand">
                <Link to="/shops/brand">品牌授权</Link>
              </Menu.Item>
            </SubMenu>
          </Menu>
        </Sider>
